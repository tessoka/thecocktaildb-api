...
const Home = () => {
  return (
    <div className="home-container">
      ...
      <p>Click on GET COCKTAIL button which will lead to the cocktail page, there you can get random cocktails or search for specific one. You can also come back to this home page by clicking on the back icon in the right bottom corner.</p>
      <Link to="/cocktail">
